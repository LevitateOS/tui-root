...
export function startPostinstallToolsApp(options: StartPostinstallToolsOptions): RenderedTuiApp {
  const app = createTuiApp({ title: "levitate-runtime-postinstall-tools" });
